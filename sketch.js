...
destroyedsceneimg=loadImage("destroyedscenery.jpg")
newBatmanimg=loadImage("newBatman.png");
ending1img=loadImage("ending.png");
...
if(gameState === PLAY){
  ...
  if(keyDown("Z")){
  missile=createSprite(100,600);
missile.addImage(missileimg); 
missile.scale=1;
missile.depth=secretBunker.depth+1;
  }
 ...
 if(score===3){
    ...
    var secretBunker=createSprite(500,400);
